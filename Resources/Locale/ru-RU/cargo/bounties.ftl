...
bounty-description-rollerskates = CentComm Security предлагает новую стратегию, которая поможет офицерам выигрывать погони пешком. Отправьте им пару испытаний, чтобы они поняли, насколько плохая это идея.bounty-description-rollerskates = Служба безопасности Центком предложила новую стратегию, которая поможет офицерам одерживать верх в пеших погонях. Пришлите им парочку, чтобы они поняли, насколько это ужасная идея.
