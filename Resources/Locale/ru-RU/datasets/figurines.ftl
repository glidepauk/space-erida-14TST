...
figurines-clown-5 = В сервисе есть один клоун, а в службе безопасности — целый отдел.
figurines-clown-6 = Я тебя раздражаю?
figurines-clown-7 = Можно мне АА? Пожалуйста?
...
figurines-salvage-6 = Глефу-крушитель? Я её едва знаю!
...
figurines-atmostech-6 = Дистра? Это сокращение от отходов.
