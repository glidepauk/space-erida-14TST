...
reagent-desc-arcryox = Отвратительно синий криогенный химикат, способный лечить даже смертельные раны у мертвых. Однако он затрудняет стабилизацию состояния пациентов.

reagent-name-warfarin = ворфэрир
reagent-desc-warfarin = Обычно используется в качестве антикоагулянта. Затрудняет свертывание крови. При передозировке может вызвать внутреннее кровотечение.
