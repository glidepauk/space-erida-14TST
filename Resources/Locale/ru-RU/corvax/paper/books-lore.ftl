...
book-clones-contents =
    ...
    Апофеозом всего этого стал “Туртельский Кризис” []Данные удалены[] года, когда несколько десятков клонов начали забастовку на малой научной станции под названием “Туртель”, находившейся на орбите Марса и занимавшейся секретными разработками компаний НаноТрейзен (именно поэтому на ней было довольно большое количество клонов-экипажа), работа станции была саботирована, а всему не клонированному персоналу было предложено эвакуироваться с неё. После того как все желающие эвакуировались, были и те, кто не являясь клонами, решили всё-таки остаться на станции тем самым выказав поддержку идеям клонов. Клоны и им сочувствующие смогли настроить аппаратуру станции на одну известную медиа-частоту и обратились по ней со своими требованиями, главным из которых было – предоставления всем клонам на территориях ОПЗ и объектах НаноТрейзен равных с обычными гуманоидами прав. В результате долгих и не очень продуктивных переговоров, НаноТрейзен не нашёл ничего лучше, чем послать на станцию отряд зачистки, прибыв на место они устроили настоящую кровавую баню и когда уже подходили к мостику, были взорваны вместе со всей станцией одним из клонов-инженеров, который смог активировать ядерную боеголовку. Когда всё произошедшее стало достоянием широкой публики репутации и активам НаноТрейзен был нанесен огромный удар, а на многих планетах и станциях прошли митинги и забастовки в поддержку клонов. Массовые беспорядки нарастали, а СМИ лишь ещё больше подливали масло в огонь, так что ОПЗ приняла “Хартию Прав Клонов” и потребовала того же от НаноТрейзен, что последние поспешили и сделать.
...
book-snk-contents =
    ...
    С НаноТрейзен правительство СНК связывает закупка некоторые патентов и научных статей, которые могли бы так или иначе помочь улучшить эффективность своих войск и получить преимущество над ОПЗ. Иные же технологии покупаются отдельными корпорациями, учреждениями и, в общей сложности, разношерстными бизнесменами. Также СНК неоднократно намекало НаноТрейзен, что если та в будущем решит выйти из состава ОПЗ насильственным способом, то СНК готово предоставить ей место в своем реестре и военную помощь в обмен на финансирование правительства. Потеря НаноТрейзен была бы крайне сильным ударом для ОПЗ и значительным дополнением казны СНК.
book-umpor-contents =
