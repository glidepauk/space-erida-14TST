...
ent-FakeMindShieldImplant = имплант "фальшивый Щит разума"
    .desc = Этот имплант позволяет имплантеру генерировать фальшивый сигнал, по которому охранные визоры НаноТрейзен идентифицируют людей, имплантированных Щитом разума.
ent-MindShieldImplant = имплант "Щит разума"
    .desc = Этот имплант обеспечит лояльность НаноТрейзен и предотвратит использование устройств контроля разума.
