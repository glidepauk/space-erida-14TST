...
ent-ClothingMaskGasCaptain = противогаз капитана
    .desc = НаноТрейзен решили срезать углы и перекрасить запасной атмос-противогаз, только никому об этом не говорите.
...
ent-ClothingMaskGasDeathSquad = противогаз эскадрона смерти
    .desc = Уникальный противогаз самого элитного отряда НаноТрейзен.
